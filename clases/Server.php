...
class Server {
    ...
    static function getUserAgent() {//navegador
    ...
    static function getClientAddress() {//ip
    ...
    static function getDestino() {
        return $_SERVER["HTTP_REFERER"];
    }

    static function verificarrDireccionCorreo($direccion){
